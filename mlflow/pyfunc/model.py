...
def _load_pyfunc(model_path):
    ...
    artifacts = {}
    artifacts_config = pyfunc_config.get(CONFIG_KEY_ARTIFACTS, {})
    for saved_artifact_name, saved_artifact_info in artifacts_config.items():
        artifacts[saved_artifact_name] = \
